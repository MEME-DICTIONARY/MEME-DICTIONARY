            ...
            <div className={styles.second_cont}>
                ...
                <article className={styles.rightSide}>
                    ...
                    <ul className={styles.word_ranking_lists}>
                        <div style={{ display: 'flex' }}><span style={{ paddingRight: '80px', color: '#fff', fontSize: '30px' }}>1</span><li className={styles.word_ranking_list}>어쩔티비 저쩔티비 시크릿쥬쥬 삼성티비 어쩔티비 저쩔티비 시크릿쥬쥬 삼성티비</li></div>
                        <div style={{ display: 'flex' }}><span style={{ paddingRight: '80px', color: '#fff', fontSize: '30px' }}>2</span><li className={styles.word_ranking_list}>신기방기 뿡뿡방기 청기백기 동방신기</li></div>
                        <div style={{ display: 'flex' }}><span style={{ paddingRight: '80px', color: '#fff', fontSize: '30px' }}>3</span><li className={styles.word_ranking_list}>알잘딱깔센</li></div>
                        <div style={{ display: 'flex' }}><span style={{ paddingRight: '80px', color: '#fff', fontSize: '30px' }}>4</span><li className={styles.word_ranking_list}>그냥 꼬옥 안아주면 되</li></div>
                        <div style={{ display: 'flex' }}><span style={{ paddingRight: '80px', color: '#fff', fontSize: '30px' }}>5</span><li className={styles.word_ranking_list}>롬곡옾눞</li></div>
                    </ul>
                </article>
            </div>
