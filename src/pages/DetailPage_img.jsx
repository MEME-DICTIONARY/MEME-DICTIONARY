    ...
    <div>
      <div class="header">
        ...
        <button class="hamburgerbtn">
          <img class="hamburgerimg" src="png/햄버거.png" />
        </button>
        <div class="searchparent">
          <input class="searchbox" type="text" style="color:white" />
          <button class="searchbtn">
            <img class="searchimg" src="png/검색.png" />
          </button>
        </div>
        <button class="personbtn">
          <img class="personimg" src="png/사람.png" />
        </button>
      </div>
      ...
      <div class="detailPage_">
        ...
        <P class="content">
          무한도전 197화 "알래스카 편"에서 방영된 장면으로, 무한도전을 안다고
          얘기하신 뒤 외치신 의미불명의 말. 그만큼 신날때 사용하면 유용한짤이다{" "}
        </P>
        ...
        <div class="buttonparent">
          <button class="bottombtn">
            <img class="buttonimg" src="png/좋아요.png" />
            20
          </button>
          <button class="bottombtn">
            <img class="buttonimg" src="png/신고.png" />
            20
          </button>
          <button class="bottombtn">
            <img class="bookmarkimg" src="png/북마크.png" />
          </button>
        </div>
      </div>
