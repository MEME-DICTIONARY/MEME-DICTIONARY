...
function DetailPage() {
  let [imghashtag, imghashtag_change] = useState([
    "#무야호",
    "#무한도전",
    "#신조어",
  ]);
  let [wordhashtag, wordhashtag_change] = useState([
    "#어쩔티비",
    "#저쩔티비",
    "#신조어",
  ]);
    ...
    <>
      ...
      >
        ...
        <p className={styles.detailPage_wordContent}>
          줄바뀌니?? 어쩌라고, 어쩔건데, 안물어봤는데 등의 의미. 상대방이 귀찮게
          하거나 대답하기 곤란한 질문을 했을 경우에 하는 말로, 상대방을 도발하는
          의미
        </p>
        <br />
        <br />
      ...
      <div
        className={`${styles.detailPage_imgBody_Container} ${styles.detailPage_imgBody_Hidden}`}
      >
        ...
        <p className={styles.detailPage_imgContent}>
          무한도전 197화 '알레스카 편'에 방영된 장면으로, 무한도전을 안다고
          얘기하신 뒤 외치신 의미불명의 말이다. 그만큼 신날때 사용하면 유용한
          짤이다.
        </p>
        <div className={styles.detailPage_hashtagParent}>
